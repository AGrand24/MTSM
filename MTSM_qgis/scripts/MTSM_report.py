...
def format_report_db():
	...
	cols=['ID_site','ID_rec','xml_x','xml_y','xml_gps_height','rec_fl_adu','rec_fl_operator','jl_alias','rec_fl_rec_start','xml_rec_start','xml_rec_end','rec_fl_note','rep_sensor_pos','rep_e_contact','rep_ser_num','rec_qc_status','rec_qc_note','rec_qc_qcby']
